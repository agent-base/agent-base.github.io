  ...
  const data = [
    {
      ...
      link:
        local === "zh"
          ? "https://agent-base.app/chat/hHHwxiorZ4XaWSV5"
          : "https://agent-base.app/chat/mx1C9IN0eJcBKNlO",
      learn:
        local === "zh"
          ? "https://docs.agent-base.ai/zh-hans/application/creating-an-application"
          : "https://docs.agent-base.ai/en/application/creating-an-application",
    },
    {
      icon: "writing",
      title: t("翻译助理"),
      ...
      link:
        local === "zh"
          ? "https://agent-base.app/completion/F68G7B8bzk1hoqtA"
          : "https://agent-base.app/completion/eu92JaoaD1qphwGm",
      learn:
        local === "zh"
          ? "https://docs.agent-base.ai/zh-hans/application/creating-an-application"
          : "https://docs.agent-base.ai/en/application/creating-an-application",
    },
    {
      ...
      link:
        local === "zh"
          ? "https://agent-base.app/completion/40ddg3LbHIhOKl5h"
          : "https://agent-base.app/completion/aeFTj0VCb3Ok3TUE",
      learn:
        local === "zh"
          ? "https://docs.agent-base.ai/zh-hans/application/creating-an-application"
          : "https://docs.agent-base.ai/en/application/creating-an-application",
    },
    {
      ...
      link:
        local === "zh"
          ? "https://agent-base.app/chat/oVNMvO96PQl4iZiN"
          : "https://agent-base.app/chat/J4MpxGOjEasj5eWL",
      learn:
        local === "zh"
          ? "https://docs.agent-base.ai/zh-hans/application/creating-an-application"
          : "https://docs.agent-base.ai/en/application/creating-an-application",
    },
    {
      ...
      link: "https://cloud.agent-base.ai/",
    },
  ];
